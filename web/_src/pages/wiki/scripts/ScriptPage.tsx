...
import { RolesListState } from '../../../../src/states/RolesListState'
import RoleView from '../../../../src/components/roles/RoleView'
...
const ScriptPage: React.FC = () => {
  ...
  return (
    <IonPage>
      ...
      <IonContent>
      <IonSegment style={{ width: 'calc(100% - 20px)', margin: 'auto', marginBottom: '10px'}}>
      ...
      >
        <TranslationProvider translations={locales.roles}>
          <RoleView role={state.role ?? {} as Role} close={closeRole} />
        </TranslationProvider>
      </IonModal>
    </IonPage>
  )
