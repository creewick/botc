...
import { readData } from './services/fileService'
import fetchBotcData from './services/botcParser'
import { saveRoleIcons } from './services/scriptToolParser'

async function main() {
  dotenv.config()
  const context: Context = {
    rolesPath: '../web/public/roles.json',
    iconsPath: '../web/public/icons',
  }
  ...
  // await runStep('STEP 2: Fetch Script Tool Data', 
  // fetchScriptToolData, context)
